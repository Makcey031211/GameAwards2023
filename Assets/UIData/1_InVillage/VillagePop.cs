...
public class VillagePop : MonoBehaviour
{
    ...
    public void PopUpOpen()
    {
        ...
        gameObject.transform.DOScale(1.0f, 0.5f).SetEase(Ease.OutBack).OnComplete(() => {Close = false;}); 
    ...
    public void PopUpClose()
    {
        ...
        gameObject.transform.DOScale(0.0f, 0.5f).SetEase(Ease.InCubic).OnComplete(() => {
            Open = false;
